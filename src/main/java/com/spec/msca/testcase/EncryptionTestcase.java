...
//					Util.iv;
	...
	public static void main(String args[]) throws InvalidKeyException, NoSuchAlgorithmException, NoSuchPaddingException, InvalidAlgorithmParameterException, IllegalBlockSizeException, BadPaddingException{
		EncryptionTestcase cvt = new EncryptionTestcase();	
		String _aString = "abc";	
		String _bString	= "abdedddddddddddddddddddddddddddddddddddddd";

		cvt.doRightEncryption(_aString);
		cvt.doWrongEncryption(_aString);
	}
	
	public void doRightEncryption(String input) 
	...
	public void doWrongEncryption(String input) 
		throws NoSuchAlgorithmException, NoSuchPaddingException, 
				InvalidKeyException, InvalidAlgorithmParameterException, 
				IllegalBlockSizeException, BadPaddingException
	{
